//Note: This is a slightly modified version of the original mousemanager.h.
...
// Purpose:     wxMouseEventsManagerMod class declaration
...
#ifndef _WX_MOUSEMANAGERMOD_H_
#define _WX_MOUSEMANAGERMOD_H_

#include "wx/event.h"

// ----------------------------------------------------------------------------
// wxMouseEventsManagerMod
// ----------------------------------------------------------------------------
 ...
 */
class WXDLLIMPEXP_CORE wxMouseEventsManagerMod : public wxEvtHandler
{
public:
    ...
    wxMouseEventsManagerMod() { Init(); }
    wxMouseEventsManagerMod(wxWindow *win) { Init(); Create(win); }
    bool Create(wxWindow *win);

    virtual ~wxMouseEventsManagerMod();
...
private:
    ...
    wxDECLARE_NO_COPY_CLASS(wxMouseEventsManagerMod);
};
